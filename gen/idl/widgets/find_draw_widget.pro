...
;
;               NOTE: Since version 3, the cache system has been removed
;               as a quick fix to a bug report.
;
...
;               
; Modified    : Version 2, SVHH, 22 March 2001 (NOT on-lined until next bug!)
;                       Fixed bug that initialized windows = [window] instead
;                       of windows = [thiswindow]
;               Version 3, SVHH, 22 March 2022 (exactly 11 years later!)
;                       Fixed bug reported by Christian Bethge Aug. 20, 2014(!),
;                       by commenting out the cache system, which under
;                       certain circumstances would return the wrong ID
;                       s.v.h.haugan@astro.uio.no
;
; Version     : 3, 22 March 2022
;-            

FUNCTION find_draw_widget,window
  ;; COMMON find_draw_widget_cache,widgets,windows,lastcheck,topbase
  COMMON find_draw_widget_topbase, topbase 
