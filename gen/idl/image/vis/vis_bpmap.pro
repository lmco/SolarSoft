...
;	    label=label, UNIFORM_WEIGHTING=uniform_weighting, spatial_frequency_weight =spatial_frequency_weight, $
;	    data_only = data_only, $
;	    LOOPSTYLE = loopstyle, $
;	    _EXTRA=_extra
; Inputs:
...
; 13-mar-2023, kim.tolbert@nasa.gov, correct spelling of spatial_frequency_weight keyword (was spatial_freqency_weight)
;-
