...
function goesr_transfer, sat, path = path,  silent = silent, max_sat = max_sat
  ...
  if (sat eq 16) then begin
     ...
     return, { sat: sat, transfer: out, $
       gb_a1: 9.615e-6, gb_a2: 5.0636203e-07, gb_b1: 1.4690000e-05, gb_b2:7.7616903e-07, $
       area_a1: 0.80946551, area_a2: 0.040307721, area_b1: 0.80946551, area_b2: 0.0400249}
  endif else if sat eq 17 then begin
     area = { area_a1: 0.809466, area_a2: 0.0402881 , area_b1: 0.809466, area_b2: 0.0402881}
     for i= 1, 4 do out[ i, *] = out[ i, *] * area.(i-1) * 1e-4 ;area in m^2
     return, { sat: sat, transfer: out, $
       gb_a1: 9.577e-6, gb_a2: 4.84723e-07, gb_b1: 1.4790000e-05, gb_b2: 7.775e-07, $
       area_a1: 0.809466, area_a2: 0.0402881 , area_b1: 0.809466, area_b2: 0.0402881}
  endif
