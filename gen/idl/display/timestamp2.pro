...
;   18-Mar-2022, Zarro (ADNET) - renamed to not conflict with IDL TIMESTAMP function
;
;-

pro TIMESTAMP2, dummy, charsize=charsize, charthick=charthick, color=color, bottom=bottom
